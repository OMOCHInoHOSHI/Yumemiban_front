...
const PostInput_Screen = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Components.RoundedBox, { width: "70%", height: "calc(35vh)", color: "#f0f0f0", borderRadius: "15px", justifyContent: "center", alignItems: "center", margin: "0 auto" },
            React.createElement("div", { className: "rounded-box-content" },
                React.createElement("p", { className: "dynamic-margin", style: { opacity: isNovelGenerated ? 1 : 0 } }, ja_text.generated_novel_label),
                React.createElement("button", { className: "dynamic-button", onClick: sendcreateNovle, style: { marginTop: isNovelGenerated ? "0" : "-20px" } }, ja_text.generate_button_label),
                isNovelGenerated && (React.createElement("div", { className: `novel-text-field ${isNovelGenerated ? "expanded" : ""}` },
